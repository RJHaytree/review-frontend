                        ...
                        <v-card style="height: 100%" elevation="2">
                            ...
                            <div v-if="selected > 0">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="6">
                                        <p><b>Rating: </b> {{ selectedData[0].average_rating }}</p>
                                    </v-col>
                                </v-row>
...
let url = 'https://electro-review-api-backend.azurewebsites.net/bi/highest/avg/global'

export default {
    name: 'HighestAvgGlobalComponent',
    props: ['name'],
    data: () => {
        return {
            data: '',
